...
import de.beowulf.libretranslater.utils.Constants
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.info.setOnClickListener {
            ...
            tvServerUrl.movementMethod = LinkMovementMethod.getInstance()
    ...
    private fun retrieveLanguages() {
        val server: String? = settings.getString("server", Constants.SERVER)
